...
int Card::getGenericCost() const { 
    return genericCost; 
}

int Card::getRedCost() const { 
    return redCost; 
}

int Card::getBlueCost() const { 
    return blueCost; 
}

int Card::getGreenCost() const { 
    return greenCost; 
}

char Card::getRarity() const { 
    return rarity; 
}

int Card::totalCost() const { 
