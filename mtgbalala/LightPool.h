...
public:
    ...
    void spendMana(int costR, int costB, int costG, int costGeneric) {
        ...
        while (genericRemaining > 0 && green > 0) { green--; genericRemaining--; }
        while (genericRemaining > 0 && blue > 0)  { blue--; genericRemaining--; }
        while (genericRemaining > 0 && red > 0)   { red--; genericRemaining--; }
    }
